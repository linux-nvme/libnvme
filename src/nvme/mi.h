...
/**
 * struct nvme_mi_aem_callbacks - Provided for nvme_mi_aem_enable
 ...
 * @enabled: buffer indexed by AE event ID of enabled state
 * @len: length of enabled.  Must be 256 bytes.
 *
 * Return: 0 is a success, nonzero is an error and errno may be read for further details
 */
