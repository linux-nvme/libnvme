				...
				size_t *occ_list_num_bytes)
{
	...
	if (enable_list_length < sizeof(struct nvme_mi_aem_enable_list) ||
...
void nvme_mi_aem_aeei_set_aeeid(__u8 aeeid, struct nvme_mi_aem_enable_item *item)
{
...
void nvme_mi_aem_aeei_set_aee(bool enabled, struct nvme_mi_aem_enable_item *item)
{
	__u16 temp = le16_to_cpu(item->aeei);
...
void nvme_mi_aem_aesi_set_aesid(__u8 aesid, struct nvme_mi_aem_supported_item *item)
{
...
void nvme_mi_aem_aesi_set_aee(bool enabled, struct nvme_mi_aem_supported_item *item)
{
	__u16 temp = le16_to_cpu(item->aesi);
	__u8 bit = (enabled) ? 1 : 0;
...
void nvme_mi_aem_aeolli_set_aeoltl(__u32 aeoltl, struct nvme_mi_aem_occ_list_hdr *hdr)
{
